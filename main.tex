...
\begin{equation}
    T_b \, [\text{K}] = 198.2 + \sum_{i=1}^{m} n_{i} \times T_{b,i}
    \label{eq:boiling_temp}
\end{equation}


\begin{equation}
    H_{vap} \, [\text{kJ/mol}] = 15.30 + \sum_{i=1}^{m} n_{i} \times H_{vap,i}
    \label{eq:enthalpy_vap}
\end{equation}


\begin{equation}
    P_c \, [\text{bar}] = \left[ 0.113 + 0.0032 N_a - \sum_{i=1}^{m} n_{i} \times P_{c,i} \right]^{-2}
    \label{eq:critical_pressure}
\end{equation}

\begin{equation}
    V_c \, [\text{cm}^3/\text{mol}] = 17.5 + \sum_{i=1}^{m} n_{i} \times V_{c,i}
    \label{eq:critical_mol_vol}
\end{equation}

\begin{equation}
    T_c \, [\text{K}] = T_b \left[ 0.584 + 0.965 \sum_{i=1}^{m} n_{i} \times T_{c,i} - \left( \sum_{i=1}^{m} n_{i} \times T_{c,i} \right)^2 \right]^{-1}
    \label{eq:critical_temperature}
\end{equation}


\begin{equation}
    T_m \, [\text{K}] = 122.5 + \sum_{i=1}^{m} n_{i} \times T_{m,i}
